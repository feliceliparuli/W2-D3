...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "blue-gray":
      ...
      break;
    default:
      console.log("No character with these characteristic");
  }
}
...
let crewMass = 600;
let counter = 0;
while (counter < starWarsCharacters.lenght) {
  crewMass += starWarsCharacters[i].mass;
  counter++;
}
console.log("La massa totale è" + " " + crewMass);
// la massa mi viene sempre 0 non capisco il motivo
...
*/
let casuale = (starWarsCharacters[
  Math.floor(Math.random() * starWarsCharacters.length)
] =
  "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente vero blanditiis deleniti ratione amet voluptatum. Dolor, aspernatur? Perferendis nobis, dolorem itaque dolorum nostrum a, eos perspiciatis vero soluta sequi rerum?");
console.log(casuale);
